...
function onCreate() {
	...
	for(var l = 0; l < pages; l++){
		// tính theo chiều ngang thì offsetX tăng theo PageContentWidth + O.X 
		var offsetX = (game.width-levelLength)/2+game.width*l;
		// 20
		//340
		//660
		console.log(offsetX + " game Width " + game.width + " level Lenght" + levelLength);
		...
		// looping through each level thumbnails
	     for(var i = 0; i < thumbRows; i ++){
	     	for(var j = 0; j < thumbCols; j ++){  
				...
				console.log("levelThumb frame "+levelThumb.frame)
